...
class AutoSSCreepsConfig {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_CreepsConfig.xml');
            }
    ...
    getAutoSSCreepsConfigInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSCreepsConfig = AutoSSCreepsConfig;
//# sourceMappingURL=autosscreepsconfig.js.map