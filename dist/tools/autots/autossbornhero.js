...
class AutoSSbornhero {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/SSGuideCfg/SS_bornhero.xml');
            }
    ...
    getAutoSSbornheroInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSbornhero = AutoSSbornhero;
//# sourceMappingURL=autossbornhero.js.map