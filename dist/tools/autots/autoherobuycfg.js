...
class AutoHeroBuyCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/HeroBuyCfg.xml');
            }
    ...
    getAutoHeroBuyCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoHeroBuyCfg = AutoHeroBuyCfg;
//# sourceMappingURL=autoherobuycfg.js.map