...
class AutoSkillCfgbuff {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_buff.xml');
            }
    ...
    getAutoSkillCfgbuffInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgbuff = AutoSkillCfgbuff;
//# sourceMappingURL=autoskillcfgbuff.js.map