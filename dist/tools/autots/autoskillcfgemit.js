...
class AutoSkillCfgemit {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_emit.xml');
            }
    ...
    getAutoSkillCfgemitInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgemit = AutoSkillCfgemit;
//# sourceMappingURL=autoskillcfgemit.js.map