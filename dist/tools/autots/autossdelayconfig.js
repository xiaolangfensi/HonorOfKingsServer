...
class AutoSSDelayConfig {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_DelayConfig.xml');
            }
    ...
    getAutoSSDelayConfigInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSDelayConfig = AutoSSDelayConfig;
//# sourceMappingURL=autossdelayconfig.js.map