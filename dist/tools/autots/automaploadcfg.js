...
class AutoMapLoadCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapLoadCfg.xml');
            }
    ...
    getAutoMapLoadCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoMapLoadCfg = AutoMapLoadCfg;
//# sourceMappingURL=automaploadcfg.js.map