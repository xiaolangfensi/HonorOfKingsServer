...
class AutoSkillCfgswitch {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_switch.xml');
            }
    ...
    getAutoSkillCfgswitchInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgswitch = AutoSkillCfgswitch;
//# sourceMappingURL=autoskillcfgswitch.js.map