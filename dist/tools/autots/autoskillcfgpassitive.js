...
class AutoSkillCfgpassitive {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_passitive.xml');
            }
    ...
    getAutoSkillCfgpassitiveInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgpassitive = AutoSkillCfgpassitive;
//# sourceMappingURL=autoskillcfgpassitive.js.map