...
class AutoSSSoldierWaypoints {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_SoldierWaypoints.xml');
            }
    ...
    getAutoSSSoldierWaypointsInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSSoldierWaypoints = AutoSSSoldierWaypoints;
//# sourceMappingURL=autosssoldierwaypoints.js.map