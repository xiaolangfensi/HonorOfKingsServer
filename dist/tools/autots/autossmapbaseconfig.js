...
class AutoSSMapBaseConfig {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_MapBaseConfig.xml');
            }
    ...
    getAutoSSMapBaseConfigInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSMapBaseConfig = AutoSSMapBaseConfig;
//# sourceMappingURL=autossmapbaseconfig.js.map