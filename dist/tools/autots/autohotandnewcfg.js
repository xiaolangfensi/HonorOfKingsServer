...
class AutoHotAndNewCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/HotAndNewCfg.xml');
            }
    ...
    getAutoHotAndNewCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoHotAndNewCfg = AutoHotAndNewCfg;
//# sourceMappingURL=autohotandnewcfg.js.map