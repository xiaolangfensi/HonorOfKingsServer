...
class AutoSSbornnpc {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/SSGuideCfg/SS_bornnpc.xml');
            }
    ...
    getAutoSSbornnpcInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSbornnpc = AutoSSbornnpc;
//# sourceMappingURL=autossbornnpc.js.map