...
class AutoSkillCfgrebound {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_rebound.xml');
            }
    ...
    getAutoSkillCfgreboundInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgrebound = AutoSkillCfgrebound;
//# sourceMappingURL=autoskillcfgrebound.js.map