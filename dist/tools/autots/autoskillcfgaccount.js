...
class AutoSkillCfgaccount {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_account.xml');
            }
    ...
    getAutoSkillCfgaccountInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgaccount = AutoSkillCfgaccount;
//# sourceMappingURL=autoskillcfgaccount.js.map