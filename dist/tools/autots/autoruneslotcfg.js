...
class AutoRuneSlotCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/RuneSlotCfg.xml');
            }
    ...
    getAutoRuneSlotCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoRuneSlotCfg = AutoRuneSlotCfg;
//# sourceMappingURL=autoruneslotcfg.js.map