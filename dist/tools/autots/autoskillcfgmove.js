...
class AutoSkillCfgmove {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_move.xml');
            }
    ...
    getAutoSkillCfgmoveInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgmove = AutoSkillCfgmove;
//# sourceMappingURL=autoskillcfgmove.js.map