...
class AutoSSAltarConfig {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_AltarConfig.xml');
            }
    ...
    getAutoSSAltarConfigInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSAltarConfig = AutoSSAltarConfig;
//# sourceMappingURL=autossaltarconfig.js.map