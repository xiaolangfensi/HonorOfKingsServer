...
class AutoOtherItemCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/OtherItemCfg.xml');
            }
    ...
    getAutoOtherItemCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoOtherItemCfg = AutoOtherItemCfg;
//# sourceMappingURL=autootheritemcfg.js.map