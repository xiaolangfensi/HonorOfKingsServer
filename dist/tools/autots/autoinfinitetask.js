...
class AutoInfiniteTask {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/InfiniteTask.xml');
            }
    ...
    getAutoInfiniteTaskInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoInfiniteTask = AutoInfiniteTask;
//# sourceMappingURL=autoinfinitetask.js.map