...
class AutoSkillCfgoverlap {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_overlap.xml');
            }
    ...
    getAutoSkillCfgoverlapInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgoverlap = AutoSkillCfgoverlap;
//# sourceMappingURL=autoskillcfgoverlap.js.map