...
class AutoSSBuildBeHurt {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/SSGuideCfg/SS_BuildBeHurt.xml');
            }
    ...
    getAutoSSBuildBeHurtInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSBuildBeHurt = AutoSSBuildBeHurt;
//# sourceMappingURL=autossbuildbehurt.js.map