...
class AutoSkillCfgfly {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_fly.xml');
            }
    ...
    getAutoSkillCfgflyInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgfly = AutoSkillCfgfly;
//# sourceMappingURL=autoskillcfgfly.js.map