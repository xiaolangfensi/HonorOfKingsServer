...
class AutoVIPIntegralCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/VIPIntegralCfg.xml');
            }
    ...
    getAutoVIPIntegralCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoVIPIntegralCfg = AutoVIPIntegralCfg;
//# sourceMappingURL=autovipintegralcfg.js.map