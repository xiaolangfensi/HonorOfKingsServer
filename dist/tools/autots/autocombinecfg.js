...
class AutoCombineCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/CombineCfg.xml');
            }
    ...
    getAutoCombineCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoCombineCfg = AutoCombineCfg;
//# sourceMappingURL=autocombinecfg.js.map