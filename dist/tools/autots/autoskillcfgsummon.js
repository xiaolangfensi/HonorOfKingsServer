...
class AutoSkillCfgsummon {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_summon.xml');
            }
    ...
    getAutoSkillCfgsummonInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgsummon = AutoSkillCfgsummon;
//# sourceMappingURL=autoskillcfgsummon.js.map