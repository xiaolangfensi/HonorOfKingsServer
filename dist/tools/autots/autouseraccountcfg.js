...
class AutoUserAccountCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/UserAccountCfg.xml');
            }
    ...
    getAutoUserAccountCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoUserAccountCfg = AutoUserAccountCfg;
//# sourceMappingURL=autouseraccountcfg.js.map