...
class AutoMapObjCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapObjCfg.xml');
            }
    ...
    getAutoMapObjCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoMapObjCfg = AutoMapObjCfg;
//# sourceMappingURL=automapobjcfg.js.map