...
class AutoSkillCfgpurification {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_purification.xml');
            }
    ...
    getAutoSkillCfgpurificationInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgpurification = AutoSkillCfgpurification;
//# sourceMappingURL=autoskillcfgpurification.js.map