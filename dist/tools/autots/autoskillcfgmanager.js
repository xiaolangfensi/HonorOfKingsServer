...
class AutoSkillCfgmanager {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_manager.xml');
            }
    ...
    getAutoSkillCfgmanagerInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgmanager = AutoSkillCfgmanager;
//# sourceMappingURL=autoskillcfgmanager.js.map