...
class AutoSkillCfgleading {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_leading.xml');
            }
    ...
    getAutoSkillCfgleadingInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgleading = AutoSkillCfgleading;
//# sourceMappingURL=autoskillcfgleading.js.map