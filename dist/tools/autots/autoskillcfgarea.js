...
class AutoSkillCfgarea {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_area.xml');
            }
    ...
    getAutoSkillCfgareaInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgarea = AutoSkillCfgarea;
//# sourceMappingURL=autoskillcfgarea.js.map