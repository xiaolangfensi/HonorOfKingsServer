...
class AutoMsgSettingCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MsgSettingCfg.xml');
            }
    ...
    getAutoMsgSettingCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoMsgSettingCfg = AutoMsgSettingCfg;
//# sourceMappingURL=automsgsettingcfg.js.map