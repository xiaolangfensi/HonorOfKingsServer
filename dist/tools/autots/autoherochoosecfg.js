...
class AutoHeroChooseCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/HeroChooseCfg.xml');
            }
    ...
    getAutoHeroChooseCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoHeroChooseCfg = AutoHeroChooseCfg;
//# sourceMappingURL=autoherochoosecfg.js.map