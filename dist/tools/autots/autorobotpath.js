...
class AutoRobotPath {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/RobotPath.xml');
            }
    ...
    getAutoRobotPathInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoRobotPath = AutoRobotPath;
//# sourceMappingURL=autorobotpath.js.map