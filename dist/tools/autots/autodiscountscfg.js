...
class AutoDiscountsCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/DiscountsCfg.xml');
            }
    ...
    getAutoDiscountsCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoDiscountsCfg = AutoDiscountsCfg;
//# sourceMappingURL=autodiscountscfg.js.map