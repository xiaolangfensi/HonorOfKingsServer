...
class AutoSkillCfgbloodseek {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_bloodseek.xml');
            }
    ...
    getAutoSkillCfgbloodseekInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgbloodseek = AutoSkillCfgbloodseek;
//# sourceMappingURL=autoskillcfgbloodseek.js.map