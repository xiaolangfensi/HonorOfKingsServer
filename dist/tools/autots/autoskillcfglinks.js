...
class AutoSkillCfglinks {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_links.xml');
            }
    ...
    getAutoSkillCfglinksInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfglinks = AutoSkillCfglinks;
//# sourceMappingURL=autoskillcfglinks.js.map