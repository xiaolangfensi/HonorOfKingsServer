...
class AutoSSHeroBirthConfig {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/MapConfig/SS_HeroBirthConfig.xml');
            }
    ...
    getAutoSSHeroBirthConfigInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSHeroBirthConfig = AutoSSHeroBirthConfig;
//# sourceMappingURL=autossherobirthconfig.js.map