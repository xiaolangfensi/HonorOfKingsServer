...
class AutoSSuserHero {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/SSGuideCfg/SS_userHero.xml');
            }
    ...
    getAutoSSuserHeroInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSSuserHero = AutoSSuserHero;
//# sourceMappingURL=autossuserhero.js.map