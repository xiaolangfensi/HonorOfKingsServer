...
class AutoDailyBonus {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/DailyBonus.xml');
            }
    ...
    getAutoDailyBonusInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoDailyBonus = AutoDailyBonus;
//# sourceMappingURL=autodailybonus.js.map