...
class AutoWildMonsterCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/WildMonsterCfg.xml');
            }
    ...
    getAutoWildMonsterCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoWildMonsterCfg = AutoWildMonsterCfg;
//# sourceMappingURL=autowildmonstercfg.js.map