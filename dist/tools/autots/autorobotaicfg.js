...
class AutoRobotAICfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/RobotAICfg.xml');
            }
    ...
    getAutoRobotAICfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoRobotAICfg = AutoRobotAICfg;
//# sourceMappingURL=autorobotaicfg.js.map