...
class AutoOtherItemCfgDescribe {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/OtherItemCfgDescribe.xml');
            }
    ...
    getAutoOtherItemCfgDescribeInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoOtherItemCfgDescribe = AutoOtherItemCfgDescribe;
//# sourceMappingURL=autootheritemcfgdescribe.js.map