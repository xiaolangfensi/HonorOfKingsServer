...
class AutoSkillCfgrelive {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/NewSkill/SkillCfg_relive.xml');
            }
    ...
    getAutoSkillCfgreliveInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkillCfgrelive = AutoSkillCfgrelive;
//# sourceMappingURL=autoskillcfgrelive.js.map