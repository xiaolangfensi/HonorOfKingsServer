...
class AutoSkinsPurchaseCfg {
    ...
    static getInstance() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this._instance) {
                ...
                yield this._instance.initialize('./conf/SkinsPurchaseCfg.xml');
            }
    ...
    getAutoSkinsPurchaseCfgInfoItem(key) {
        return this._mapInfo.get(key);
    }
}
exports.AutoSkinsPurchaseCfg = AutoSkinsPurchaseCfg;
//# sourceMappingURL=autoskinspurchasecfg.js.map